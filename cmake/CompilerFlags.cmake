...
SET(CMAKE_C_FLAGS "${PLATFORM_FLAGS} ${SECTIONS} ${SHARE_SETTINGS} ${OPT_FLAGS} -Wall -std=gnu17")
...
SET(CMAKE_EXE_LINKER_FLAGS "-Wl,--gc-sections  ${PLATFORM_FLAGS} ${SPECS} -lc -lm -flto -T ${CMAKE_CURRENT_SOURCE_DIR}/chip/${CHIP}/${APP_START_ADDR}/link.ld -Wl,-Map=${TARGET}.map") #  #-u _printf_float
